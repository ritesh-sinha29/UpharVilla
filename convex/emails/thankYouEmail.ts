  ...
  handler: async (ctx) => {
    ...
    for (const order of orders) {
      ...
      const body = `
        ...
        <tr><td style="padding:36px 40px 0;text-align:center;text-align:left;">

          <p style="margin:0 0 10px;font-size:20px;font-weight:700;color:${B.textDark};font-family:Poppins,Arial,sans-serif;text-align:center;">
            Thank you, ${firstName}
          </p>
          <p style="margin:0 0 24px;font-size:14px;color:${B.textMid};line-height:1.8;font-family:Poppins,Arial,sans-serif;max-width:420px;margin-left:auto;margin-right:auto;text-align:center;">
          ...
          <!-- Delivered card -->
          <table cellpadding="0" cellspacing="0" style="margin:0 auto 28px;border-collapse:collapse;">
            <tr>
              <td style="background:#faf9ff;border:1px solid ${B.border};border-radius:12px;padding:16px 28px;text-align:center;">
          ...
          <p style="margin:0 0 8px;font-size:14px;color:${B.textMid};font-family:Poppins,Arial,sans-serif;text-align:center;">
